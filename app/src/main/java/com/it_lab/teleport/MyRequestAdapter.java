...
public class MyRequestAdapter extends BaseAdapter {
    ...
    public MyRequestAdapter (Context context, List<Request> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(view ==null)
        {
            view=inflater.inflate(R.layout.item_my_reguest,parent,false);
        }

        TextView textView= (TextView) view.findViewById(R.id.myRequestName);
